...
# Dict of all layers available in WMS for each collection
# TODO : Add other layers when available
DICT_LAYER = {
    'Sentinel1-GRD': [('IW_VV', 0), ('IW_VV_DB', 2), ('IW_VH', 4), ('IW-VH-DB', 5)],
    'Sentinel2-L1C': [('1_NATURAL_COLOR', 1), ('2_COLOR_INFRARED__VEGETATION_', 2), ('3_FALSE_COLOR__URBAN_', 3),
                      ('4_AGRICULTURE', 4), ('6_MOISTURE_INDEX', 6), ('7_GEOLOGY', 7), ('8_BATHYMETRIC', 8),
                      ('09-NDVI', 0),
                      ('90_ATMOSPHERIC_PENETRATION', 9), ('91_SWIR', 10), ('92_NDWI', 11), ('93-SWIR-2-11-12', 12),
                      ('B01', 13), ('B02', 14), ('B03', 15), ('B04', 16), ('B05', 17), ('B06', 18), ('B07', 19),
                      ('B08', 20),
                      ('B09', 21), ('B10', 22), ('B11', 23), ('B12', 24), ('B8A', 25)],
    'Sentinel2-L2A': [('SCL', 0), ('AGRICULTURE', 1), ('ATMOSPHERIC_PENETRATION', 2), ('BATHYMETRIC', 3),
                      ('COLOR_INFRARED', 4),
                      ('COLOR_INFRARED_URBAN', 5), ('GEOLOGY', 6), ('MOISTURE_INDEX', 7), ('SWIR', 8),
                      ('TRUE_COLOR', 9), ('VEGETATION_INDEX', 10)],
    'Sentinel5P-L2': [('AER_AI_340_380', 0), ('AER_AI_340_AND_380_VISUALIZED', 1), ('AER_AI_354_388', 2), ('CH4', 3),
                      ('CH4_VISUALIZED', 4),
                      ...
                      ('CLOUD_OPTICAL_THICKNESS', 11), ('CLOUD_OPTICAL_THICKNESS_VISUALIZED', 12),
                      ('CLOUD_TOP_HEIGHT', 13),
                      ('CLOUD_TOP_HEIGHT_VISUALIZED', 14), ('CLOUD_TOP_PRESSURE', 15),
                      ('CLOUD_TOP_PRESSURE_VISUALIZED', 16), ('CO', 17),
                      ('CO_VISUALIZED', 18), ('HCHO', 19), ('HCHO_VISUALIZED', 20), ('NO2', 21), ('NO2_VISUALIZED', 22),
                      ('O3', 23),
...
def download_images(bbox, collection, layer, start_date, stop_date,
                    title, subtitle, delta_days, height, width):
...
def get_layer(collection_widget, bbox):
    ...
    layer_widget = widgets.Dropdown(
        options=DICT_LAYER[satellite + '-' + collection],
        description='Layer',
    )
    button = widgets.Button(description='Validate')
    out = widgets.Output()
...
def gif_folder():
    ...
    vbox1 = widgets.VBox([widgets.Label('Delete some images'), file_widget, button_del, out_wid_del])
